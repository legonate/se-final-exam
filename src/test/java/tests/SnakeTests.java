...
public class SnakeTests {
    ...
    @Test
    @Order(1)
    @DisplayName("Snake Animal Type Tests Domestic")
    ...
    {
        assertNotNull(actualSnake.getNumberOfLegs());
    }
    ...
    @Test
    @Order(2)
    @DisplayName("Snake Breed Test Unknown")
    public void snakeBreedTest() {
        actualSnake = new Snake(AnimalType.WILD, Skin.UNKNOWN, Gender.FEMALE, Breed.UNKNOWN);
        assertEquals(Breed.UNKNOWN, actualSnake.getBreed(), "Expecting Breed Unknown!");
    }
    ...
    @Test
    @Order(2)
    @DisplayName("Snake Speak Default Tests")
    public void snakeGoesDefaultTest()
    {
        actualSnake = new Snake(AnimalType.UNKNOWN, Skin.UNKNOWN, Gender.UNKNOWN, Breed.UNKNOWN);
        assertEquals("The snake goes " + actualSnake.getPetType().speak + "! " + actualSnake.getPetType().speak + "!",
                actualSnake.speak(), "I was expecting default snake speak");
    }
}
